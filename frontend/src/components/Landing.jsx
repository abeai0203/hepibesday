  ...
  return (
    <div className="w-full bg-[#FDFCF0]">
      ...
      <div className="h-[200vh] w-full relative">
        ...
        {/* 2. STICKY CONTENT - THE ONLY LAYER */}
        <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-between overflow-hidden">
          ...
          <motion.div 
            ...
            className="w-full flex flex-col items-center text-center pt-10 px-6 z-40 pointer-events-none"
          >
          ...
          <motion.div 
            ...
            className="w-full max-w-xl px-6 pb-12 flex flex-col items-center z-50"
          >
